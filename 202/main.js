...
function init() {
    ...
    /**
     * TRANSFORMACIONES A LA PIRAMIDE
     */
    piramide[0].applyMatrix(Traslacion([2*lado, 2*lado, 0])); //Aplicacion de la traslacion al objeto 
    EscaladoReal(piramide[0], [2*lado, 2*lado, 0], [1.5, 1.5, 1.5]); // Escalado al objeto de 150%
    RotacionReal(piramide[0], [2*lado, 2*lado, 0], 45, 'x'); //Rotacion en x del objeto
    RotacionReal(piramide[0], [2*lado, 2*lado, 0], 45, 'y'); //Rotacion en y del objeto
    RotacionReal(piramide[0], [2*lado, 2*lado, 0], 60, 'z'); //Rotacion en z del objeto
